...
<%--        <span id="user_msg" class="err_msg">${register_msg}</span>--%>
<%--        <p>--%>
<%--            用户名:<input name="nickname" type="text" id="nickname" placeholder="请输入您的用户名，长度应在16个字符以内" style="width: 270px;" required> </p>--%>
<%--            <span id="nickname_err" class="err_msg">${nickname_msg}</span>--%>
<%--        <p>--%>
<%--            账号:<input name="username" type="text" id="username" placeholder="请输入您的账号，长度应在6个及以上字符" style="width: 270px;" required>--%>
<%--            <span id="username_err" class="err_msg">${username_msg}</span>--%>
<%--        </p>--%>

<%--        <p>--%>
<%--            密码: <input name="password" type="text" id="password" placeholder="请输入您的密码，长度应在6到20个字符之间" style="width: 270px;" required>--%>
...
<%--        </p>--%>
<%--        <p>--%>
<%--            验证码:<input name="checkCode" type="text" id="checkCode" placeholder="请您输入验证码">--%>
